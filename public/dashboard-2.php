...
<body class="font-body">
    ...
    <?php
        $id = $_SESSION['userid'];
        $sql = "SELECT userid, ethBought, ethEarnings, portfolioValue, btcPortfolio, btcPortfolioValue, ltcPortfolio, ltcPortfolioValue, ethPortfolio, ethPortfolioValue, bchPortfolio, bchPortfolioValue FROM tbl_dashboard WHERE userid=$id;";
                ...
                <div class="bg-white border border-brand-gray-light-3 border-opacity-50 rounded-md shadow-lg">
                    ...
                    <div class="flex space-x-4 p-4">
                        ...
                        <div class="flex flex-1 items-center space-x-4 p-5 border rounded-md bg-brand-blue-light-1 border-brand-border-1 border-opacity-50">
                            ...
                            <div>
                                <h2 class="text-brand-gray-dark-1 text-sm font-bold"><?php echo $ethBought. ' BTC'; ?></h2>
                        ...
                        <div class="flex flex-1 items-center space-x-4 p-5 border rounded-md bg-brand-blue-light-1 border-brand-border-1 border-opacity-50">
                            ...
                            <div>
                                <h2 class="text-brand-gray-dark-1 text-sm font-bold"><?php echo $ethEarnings. ' BTC'; ?></h2>
