<section class="py-16 md:py-20">
    <div class="md:flex items-center md:space-x-12 max-w-6xl mx-auto px-6">
        ...
        <div class="md:w-1/2 mx-auto">
            ...
            <form action="includes/subscriber.inc.php" method="POST" class="flex items-center bg-blue-100 rounded-full pl-4 font-bold focus-within:ring-2 focus-within:ring-blue-700">
