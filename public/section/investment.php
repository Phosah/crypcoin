<section class="py-10 md:py-20">
    ...
    <p class="max-w-lg mx-auto text-brand-gray-light-1 text-center mb-14 px-12 md:px-6">The investment plan selected would determine your profit made on the cryptocurrency purchased</p>
