    ...
    <div class="md:flex md:space-x-16 max-w-6xl mx-auto px-12 md:px-6">
        <div class="md:w-1/3 w-64 mb-16 mx-auto pt-4 pb-12 rounded-3xl shadow-lg">
            ...
            <div class="w-9/12 mx-auto">
                ...
                <button class="bg-blue-700 w-full px-8 py-4 text-white rounded-2xl">Make Deposit</button>
            </div>
        </div>
        <div class="md:w-1/3 w-64 mb-16 mx-auto pt-4 pb-12 bg-blue-700 rounded-3xl shadow-lg">
            ...
            <div class="w-9/12 mx-auto text-white">
                ...
                <button class="bg-white w-full px-8 py-4 text-blue-700 font-semibold rounded-2xl">Make Deposit</button>
            </div>
        </div>
