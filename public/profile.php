                ...
                <div class="flex space-x-8 items-start">            
                    <div class="px-6 w-1/3">
                        ...
                        <form action="includes/upload-profile-image.inc.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-8">
                                <div class="mb-3"><input type="file" name="file"></div>
                        ...
                        <form action="includes/personal-details.inc.php" method="POST">    
                            <div class="max-w-2xl px-6">     
                                <div class="flex space-x-6 mb-8">                       
                                    <div class="flex-1 flex items-center space-x-4 border-b border-gray-500 pl-6 focus-within:border-blue-500">
                                        <div>
                                            <img src="img/user-dark.png" alt="User icon">
                                        </div>
                                        <input class="w-full bg-transparent py-4 focus-within:outline-none" type="text" name="fullname" placeholder="fullname">
                                    </div>
                                    <div class="flex-1 flex items-center space-x-4 border-b border-gray-500 pl-6 focus-within:border-blue-500">
                                        <div>                                    
                                            <img src="img/mail-dark.png" alt="Mail icon">
                                        </div>
                                        <input class="w-full bg-transparent py-4 focus-within:outline-none" type="email" name="email" placeholder="email">
                                    </div>
                                </div>
                                <div class="w-1/2 mb-24 border-b border-gray-500 px-6 focus-within:border-blue-500">
                                    <img src="" alt="">
                                    <input class="w-full bg-transparent py-4 focus-within:outline-none" type="number" name="number" placeholder="phone number">
                                </div>
