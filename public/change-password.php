            ...
            <div class="max-w-6xl mx-auto px-6 ">
                <div class="flex-1 bg-white shadow-md">
                    <div class="border-b border-gray-100 pt-6 pb-4 pl-6 mb-8">
                        ...
                        <a class="text-blue-700 font-bold" href="change-password.php">Change Password</a>
                    </div>
                    <div class="max-w-4xl mx-auto px-6">
                        <form action="includes/change-password.inc.php" method="POST">       
                            ...
                            <div class="flex space-x-6 mb-8">
                                <div class="w-1/2 items-center border-b border-gray-500 pl-6 focus-within:border-blue-600">
