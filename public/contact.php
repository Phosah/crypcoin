    ...
    <main>
        <section class="py-10 md:py-28">
            <div class="max-w-2xl mx-auto mb-8 px-6 text-center">
                <h2 class="text-brand-gray-dark-1 text-5xl font-body font-bold mb-8">Contact us</h2>
                <p class="text-brand-gray-light-1 text-2xl">It doesnt matter where you are or the time of the day, we are always here to answer you</p>
            </div>
        </section>
        <section class="py-10 md:py-28">
            <div class="md:flex items-center md:space-x-12 max-w-6xl mx-auto px-6">               
                <div class="md:w-1/2 mb-12 md:mb-0">
                    <h3 class="max-w-sm mb-12 text-brand-gray-dark-1 text-5xl font-body font-bold">Want to make more enquires?</h3>
