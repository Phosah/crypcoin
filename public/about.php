    ...
    <main>
        <section class="py-20">
            <div class="max-w-6xl mx-auto px-6 text-center">
                ...
                <p class="max-w-md mx-auto text-brand-gray-light-1">Crypcoin Binary Trade  is a private crypto trading company that deals in investments in crypto currency to yield amazing turnovers. Established in 2016 </p>
            </div>
        </section>
        <section class="py-20">
            <div class="md:flex items-center md:space-x-12 max-w-6xl mx-auto px-6">
                <div class="md:w-1/2 mb-20 md:mb-0">
                    ...
                    <p class="mb-6 text-brand-gray-light-1">We are guided by our values which represent us as a company  and these values have formed our foundation for the over 4 years and counting</p>
