    ...
    <main>
        <section class="py-28">
            <div class="max-w-6xl mx-auto px-6 text-center">
                <h2 class="text-5xl font-body font-bold text-brand-gray-dark-1 mb-8">About us</h2>
                <p class="max-w-2xl mx-auto text-brand-gray-light-1 text-2xl">Crypcoin Binary Trade  is a private crypto trading company that deals in investments in crypto currency to yield amazing turnovers. Established in 2016 </p>
            </div>
        </section>
        <section class="py-28">
            <div class="md:flex items-center md:space-x-12 max-w-6xl mx-auto px-6">
                <div class="md:w-1/2 mb-20 md:mb-0">
                    <h3 class="mb-8 text-brand-gray-dark-1 text-5xl font-body font-bold">Our values</h3>
                    ...
                    <button class="bg-blue-700 py-3 px-8 rounded-md text-white  hover:bg-white hover:text-blue-700 border hover:border-blue-700">Get started</button>
                </div>
                <div class="md:w-1/2">
                    <div class="flex mb-8">                 
                        <div class="flex flex-1 items-center space-x-4">
                            ...
                            <p class="text-brand-gray-dark-1 font-body font-bold text-xl">Trust & Respect</p>
                        </div>
                        <div class="flex flex-1 items-center space-x-4">
                            <div class="flex-shrink-0 bg-blue-200 p-2">
                                <img class="w-6" src="img/transparency.png" alt="Transparency">
                            </div>
                            <p class="text-brand-gray-dark-1 font-body font-bold text-xl">Transparency</p>
                        </div>
                    </div>
                    <div class="flex">                  
                        <div class="flex flex-1 items-center space-x-4">
                            ...
                            <p class="text-brand-gray-dark-1 font-body font-bold text-xl">Innovation</p>
                        </div>
                        <div class="flex flex-1 items-center space-x-4">
                            <div class="flex-shrink-0 bg-blue-200 p-2">
                                <img class="w-6" src="img/crown.png" alt="Simplicity">
                            </div>
                            <p class="text-brand-gray-dark-1 font-body font-bold text-xl">Simplicity</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-28">
            <div class="md:flex items-center max-w-6xl mx-auto md:space-x-12 px-6">
                ...
                <div class="md:w-1/2">
                    <h2 class="mb-8 text-center md:text-left text-5xl text-brand-gray-dark-1 font-body font-bold">Our mission</h2>
