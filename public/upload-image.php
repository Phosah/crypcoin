...
<body>
    <section class="py-20 bg-brand-gray-light-6">
        <div class="max-w-xl mx-auto pb-10 bg-white rounded-md">
            ...
            <form action="">
                <div class="w-full mx-auto space-x-4 mb-12 px-6 items-center focus:border-brand-blue-light-1">
                ...
                <div class="px-6 mb-12">   
                    <button class="bg-blue-700 text-white text-md rounded-md px-6 py-2">Save</button>
                </div>
            </form>
        </div>
    </section>
