                ...
                <div class="bg-white border border-brand-gray-light-3 border-opacity-50 rounded-md shadow-lg">
                    ...
                    <div class="flex space-x-4 p-4">
                        <div class="flex flex-1 items-center space-x-4 p-5 border rounded-md bg-brand-blue-light-1 border-brand-border-1 border-opacity-50">
                            ...
                            <div>
                                <h2 class="text-brand-gray-dark-1 text-sm font-bold"><?php echo '$'. $btc_price; ?></h2>
                        ...
                        <div class="flex flex-1 items-center space-x-4 p-5 border rounded-md bg-brand-blue-light-1 border-brand-border-1 border-opacity-50">
                            ...
                            <div>
                                <h2 class="text-brand-gray-dark-1 text-sm font-bold"><?php echo $btcBought. ' BTC'; ?></h2>
                        ...
                        <div class="flex flex-1 items-center space-x-4 p-5 border rounded-md bg-brand-blue-light-1 border-brand-border-1 border-opacity-50">
                            ...
                            <div>
                                <h2 class="text-brand-gray-dark-1 text-sm font-bold"><?php echo $btcEarnings. ' BTC'; ?></h2>
